 ...
 * or relative file path. The file should be formatted as
 * a CSV, where each row corresponds to a student.
 * @returns {Number} The total number of student records in the CSV file.
 * @example
